...
const howItWorksSteps = [
  {
    ...
    description:
      "Browse our available programs and find the one that ignites your passion, whether you're a beginner or an experienced artist.",
  },
  {
    step: 2,
    title: "Register Online",
    description:
      "Sign up for your chosen class through our simple and secure online registration form to reserve your spot.",
  },
  {
    step: 3,
    title: "Start Creating",
    description:
      "Join our welcoming studio environment and begin your artistic journey with expert guidance from our instructors.",
  },
];
...
const testimonials = [
  {
    ...
    avatarId: "avatar-1",
    quote:
      "Studio-H transformed my hobby into a real passion. The instructors are incredibly supportive and the atmosphere is so inspiring. I've learned more here in six months than I did in years on my own.",
  },
  {
    id: "testimonial-2",
    name: "Samantha Lee",
    avatarId: "avatar-2",
    quote:
      "The digital art program was fantastic. I came in with zero experience and now I feel confident creating my own illustrations. A wonderful community to be a part of!",
  },
  {
    id: "testimonial-3",
    name: "Michael Chen",
    avatarId: "avatar-3",
    quote:
      'A truly top-notch studio. The "How It Works" process was seamless, and the weekly classes are the highlight of my week. Highly recommend to anyone looking to explore their creative side.',
  },
];
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center text-primary-foreground p-4">
          ...
          >
            ...
            <p className="mt-4 mx-auto text-lg md:text-xl text-white/90 max-w-2xl">
              An independent art studio offering classes and workshops for all
              skill levels.
            </p>
      ...
      <main className="container px-4 md:px-6 py-12 md:py-20 mx-auto">
        ...
        <section className="text-center animation-fade-in">
          <h2 className="font-headline text-3xl md:text-5xl">
            The Art Studio Programs
          </h2>
          <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
            From foundational skills to advanced techniques, find the perfect
            class to nurture your creativity.
          </p>
        ...
        <section className="mt-20 md:mt-32 animation-fade-in">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
              Getting started at Studio-H is simple. Here’s your path from
              aspiring artist to creator.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
            <div className="bg-muted/50 p-8 rounded-lg">
              ...
              <p className="mt-2 text-muted-foreground">
                Invest in your passion with our straightforward weekly plan.
              </p>
              <div className="my-6">
              ...
              <p className="text-sm text-muted-foreground">
                Includes all materials, open studio access, and personalized
                instruction.
              </p>
            ...
            <div>
              ...
              <p className="mt-2 text-muted-foreground">
                Our curriculum is designed to give you a well-rounded artistic
                education.
              </p>
